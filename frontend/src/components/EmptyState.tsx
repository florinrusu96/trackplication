export default function EmptyState({ onOpenChat }: { onOpenChat: () => void }) {
  return (
    <div
      className="flex flex-col items-center justify-center px-5 py-24 text-center"
      style={{ color: "#5b6270" }}
    >
      <div
      ...
      <div className="mb-[18px] max-w-[320px] text-[13px] leading-relaxed">
        Add applications by pasting a job posting into the AI assistant — it'll
        pull out the company, role, salary, and requirements for you to confirm.
      </div>
      <button
        onClick={onOpenChat}
        className="cursor-pointer rounded-lg border px-4 py-[9px] text-[13px] font-medium"
        style={{
          borderColor: "rgba(124,154,224,.3)",
          background: "rgba(124,154,224,.1)",
          color: "#aebde8",
        }}
      >
